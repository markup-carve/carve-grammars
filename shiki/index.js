...
export const carveLightExtras = [
    ...
    { scope: 'keyword.operator.table.header', settings: { foreground: '#cf222e', fontStyle: 'bold' } },
    { scope: ['keyword.operator.table.rowspan', 'keyword.operator.table.colspan', 'keyword.operator.table.continuation'], settings: { foreground: '#cf222e', fontStyle: 'bold' } },
    { scope: 'keyword.operator.table.alignment', settings: { foreground: '#e36209' } },
    { scope: 'punctuation.separator.table', settings: { foreground: '#4f7f8d' } },
...
export const carveDarkExtras = [
    ...
    { scope: 'keyword.operator.table.header', settings: { foreground: '#ff7b72', fontStyle: 'bold' } },
    { scope: ['keyword.operator.table.rowspan', 'keyword.operator.table.colspan', 'keyword.operator.table.continuation'], settings: { foreground: '#ff7b72', fontStyle: 'bold' } },
    { scope: 'keyword.operator.table.alignment', settings: { foreground: '#ffab70' } },
    { scope: 'punctuation.separator.table', settings: { foreground: '#79a8b5' } },
...
export { diffCodeTransformer } from './diff.js'
