...
export const carveLightExtras = [
    ...
    { scope: 'punctuation.definition.emoji', settings: { foreground: '#959da5' } },
    { scope: 'constant.language.emoji', settings: { foreground: '#e36209', fontStyle: 'bold' } },
...
export const carveDarkExtras = [
    ...
    { scope: 'punctuation.definition.emoji', settings: { foreground: '#6a737d' } },
    { scope: 'constant.language.emoji', settings: { foreground: '#ffab70', fontStyle: 'bold' } },
