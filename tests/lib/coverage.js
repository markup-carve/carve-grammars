...
const TIPTAP_SKIP = new Map([
    ...
    ['28-hard-line-breaks', 'the converter does not model the `hard_break` node'],
    ...
    ['34-thematic-breaks', 'the converter does not model the `thematic_break` node'],
    ...
    ['44-mentions-and-tags', 'mention and tag inline nodes are not modeled'],
    ...
    ['54-fenced-code-shorter-inner-fence', 'the converter does not model the `code_block` node'],
    ...
    ['59-mention-ignores-email-addresses', 'mention inline nodes are not modeled'],
    ['60-tag-requires-a-word-boundary', 'tag inline nodes are not modeled'],
    ...
    ['68-nested-containers', 'admonition containers are not modeled'],
    ...
    ['71-parenthesized-ordered-marker', 'the parenthesized ordered marker is not preserved on serialize'],
    ...
    ['81-fenced-code-language-with-punctuation', 'the converter does not model the `code_block` node'],
    ...
    ['100-block-quote-continuation-marker', 'the converter does not model the `block_quote` node'],
    ...
    ['132-footnote-definition-requires-an-inline-body', 'the converter does not model the `soft_break` node'],
    ...
    ['151-attribute-block-after-a-mention-stays-literal', 'the converter does not model the `mention` node'],
    ...
    ['154-wrapped-definition-term-continuation-below-the-content-column-strips-leading-whitespace', 'the converter does not model the `definition_list` node'],
